/*********************************************************************
 ...
 作   者 :
 创建时间 : 2013-08-20
 文件描述 : 数据库查询结果模板类，操作每条查询结果,将查询结果封装为字典，继承ResultSetHandler
 *********************************************************************/

#import "FTListMapHandler.h"
#import "FTDBModelUtil.h"

@implementation FTListMapHandler
...
{
    NSMutableDictionary *resultDic = [FTDBModelUtil getOneDicFromDBase:stmt];
